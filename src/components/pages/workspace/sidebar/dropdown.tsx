...
import { FileType } from "@/lib/supabase/supabase.types";
        ...
        <div className={groupIdentifies}>
          ...
          >
            ...
            <input
              ...
              className={clsx(
                "outline-none overflow-hidden w-[140px] text-basic-7",
                {
          ...
          <div className={hoverStyles}>
            ...
            >
              <Trash
                onClick={moveToTrash}
                size={15}
                className="hover:dark:text-white dark:text-basic-7 transition-colors"
              />
            </CustomTooltip>
