...
const WorkspaceDropdown: React.FC<Props> = ({
  ...
  return (
    <div className="relative inline-block w-full text-left">
      ...
      {isOpen && (
        <div className="origin-top-right absolute rounded-md shadow-md z-50 max-h-[190px] bg-black/10 backdrop-blur-lg overflow-y-auto overflow-x-hidden group border-[1px] border-muted w-full">
